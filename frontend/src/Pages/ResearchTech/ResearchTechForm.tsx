    ...
    return(
        <>
            ...
            <div className="flex flex-row justify-center">
                ...
                ${selectedCostLevel === "High" ? "bg-[var(--bg-color-200)] border-teal-600 border-2 text-teal-600" : "bg-[var(--bg-color-100)]"}`} 
                onClick={() => {
                ...
                ${selectedCostLevel === "Moderate" ? "bg-[var(--bg-color-200)] border-teal-600 border-2 text-teal-600" : "bg-[var(--bg-color-100)]"}`} 
                onClick={() => {
                ...
                ${selectedCostLevel === "Low" ? "bg-[var(--bg-color-200)] border-teal-600 border-2 text-teal-600" : "bg-[var(--bg-color-100)]"}`} 
                onClick={() => {
